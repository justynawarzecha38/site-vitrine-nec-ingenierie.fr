...
<nav id="page-navbar" class="navbar navbar-expand-lg fixed-top navbar-light">
    <div class="container-md">
        <a class="navbar-brand" href="./index.php">
            <img class="w-auto h-100" src="./images/logos/Logo_NEC_quadri.svg?v=<?php echo(date("Y-m-d-H-i-s", filemtime('./images/logos/Logo_NEC_quadri.svg'))) ?>" alt="" width="215" height="84">
        </a>
