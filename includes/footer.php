        ...
        <div class="row gx-5 gy-4">
            ...
            <div class="col-12 col-lg-4 text-center text-lg-start">
                <div style="height: 64px; opacity: 0.65;">
                    <img class="img-contain" src="./images/logos/Logo_NEC_Concept.png?v=<?php echo(date("Y-m-d-H-i-s", filemtime('./images/logos/Logo_NEC_Concept.png'))) ?>" alt="Logo NEW Énergie Concept (noir)">
                </div>
